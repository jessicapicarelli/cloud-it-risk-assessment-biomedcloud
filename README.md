...
| Folder/File | Content |
|---|---|
| `docs/01-executive-summary.md` | Executive summary of the assessment |
| `docs/02-scope.md` | Scope of the assessment |
| `docs/03-methodology.md` | Methodology used (likelihood/impact rating scales) |
| `docs/04-risk-assessment.md` | Detailed assessment of each identified risk |
| `docs/05-risk-control-matrix.md` | Consolidated Risk & Control Matrix |
| `docs/06-findings.md` | Audit findings |
